...
ゲームエンジンのUnityと同名ですが、それを言い出すとVim-UniteはUnityの大規模イベント（[Unite](https://events.unity3d.jp/unitetokyo/)）と同名なので…まあいっか😙とそっと蓋を閉じました😙
...
[vim_to_hidemaru.md](vim_to_hidemaru.md)
